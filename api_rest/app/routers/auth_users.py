...
fake_users_db = {
    ...
    "pepe": { 
        ...
        "email": "johndoe@example.com",
        "disabled": False,
        "password": "$argon2id$v=19$m=65536,t=3,p=4$x2yXnuD8EahkZ3L4Z/WT8w$g9syJFPL5WzG65awg4KS9sQtOXqkMs0RKRXrqntoFqc"
    }
}
...
async def register_user(user: UserDB):
    new_password = password_hash.hash(user.password)
